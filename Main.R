...
republican_party_primary_polling[297:306,"Sample_Size"]<-491

republican_party_primary_polling[270,"Polling"]<-1

democratic_party_primary_polling[67,"Polling"]<-9

democratic_party_primary_polling[36,"Polling"]<-1
democratic_party_primary_polling[36,"Candidate"]<-"Alexandria Ocasio-Cortez"
democratic_party_primary_polling[72,"Candidate"]<-"Alexandria Ocasio-Cortez"

democratic_party_primary_polling[226,"Polling"]<-3

republican_party_primary_polling[485,"Polling"]<-7
